                ...
                <form method="POST" action="{{ route('visiteur.demande.post') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="horaire-row">
                            ...
                            <input type="time" name="horaires[{{ $jour }}][ouverture]"
                                   class="form-control form-control-sm"
                                   value="{{ old('horaires.'.$jour.'.ouverture') }}">
                            <span class="text-muted fw-bold">—</span>
                            <input type="time" name="horaires[{{ $jour }}][fermeture]"
                                   class="form-control form-control-sm"
                                   value="{{ old('horaires.'.$jour.'.fermeture') }}">
                        </div>
                        @endforeach
                    </div>
