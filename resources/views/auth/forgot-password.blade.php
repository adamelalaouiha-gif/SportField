...
<div class="card-box text-center">
    ...
    @if(session('success'))
        <div class="alert alert-success text-start"><i class="bi bi-check-circle me-2"></i>{{ session('success') }}</div>
    @endif
    @if($errors->any())
    ...
    <form method="POST" action="{{ route('password.forgot.send') }}" class="text-start">
        @csrf
        <div class="mb-4">
