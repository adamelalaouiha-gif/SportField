...
<div class="card-box text-center">
    ...
    <p class="text-muted mb-4">Un code à 6 chiffres a été envoyé à <strong>{{ $email }}</strong>. Entrez-le ci-dessous pour activer votre compte.</p>
    ...
    <form method="POST" action="{{ route('verification.verify') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="code" class="form-control code-input" placeholder="______"
                   maxlength="6" value="{{ old('code') }}" required autocomplete="off">
