...
@section('content')
    ...
    {{-- Passer les horaires du club en JSON pour le JS --}}
    @php
                        ...
                        <div class="border-top pt-3 mt-2">
                            ...
                            @foreach(['Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi','Dimanche'] as $jour)
                                ...
                                <div class="d-flex justify-content-between small mb-1">
                                    ...
                                    @if($horStr)
                                        <span class="fw-medium">{{ $horStr }}</span>
                                    @else
            ...
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <form method="POST" action="{{ route('client.reserver.post', $terrain->id) }}">
                        ...
                        {{-- FORMULAIRE CARTE (visible seulement si en_ligne) --}}
    ...
    @section('scripts')
        <script>
            const horairesRaw = {!! $horairesJson !!};
            const joursMap    = {!! $joursMapJson !!};
            const oldDate     = "{{ old('date_reservation') }}";
            const oldDebut    = "{{ old('heure_debut') }}";
            const oldFin      = "{{ old('heure_fin') }}";
