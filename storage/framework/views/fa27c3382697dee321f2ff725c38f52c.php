            ...
            <div class="form-card">
                ...
                <form method="POST" action="<?php echo e(route('client.reserver.post', $terrain->id)); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="date_reservation" class="form-control" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" value="<?php echo e(old('date_reservation')); ?>" required>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <label class="form-label fw-semibold">Heure de début <span class="text-danger">*</span></label>
                            <input type="time" name="heure_debut" class="form-control" value="<?php echo e(old('heure_debut')); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Heure de fin <span class="text-danger">*</span></label>
                            <input type="time" name="heure_fin" class="form-control" value="<?php echo e(old('heure_fin')); ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
