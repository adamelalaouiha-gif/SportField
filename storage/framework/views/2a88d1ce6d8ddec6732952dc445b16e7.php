...
<head>
    ...
    <title>Vérification Email - SportsField</title>
...
<div class="card-box text-center">
    ...
    <h3 class="fw-bold mb-2">Vérifiez votre email</h3>
    <p class="text-muted mb-4">Un code à 6 chiffres a été envoyé à <strong><?php echo e($email); ?></strong>. Entrez-le ci-dessous pour activer votre compte.</p>

    <?php if(session('success')): ?>
        <div class="alert alert-success"><i class="bi bi-check-circle me-2"></i><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('info')): ?>
        <div class="alert alert-info"><i class="bi bi-info-circle me-2"></i><?php echo e(session('info')); ?></div>
    <?php endif; ?>
    <?php if($errors->any()): ?>
    ...
    <form method="POST" action="<?php echo e(route('verification.verify')); ?>">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="code" class="form-control code-input" placeholder="______"
                   maxlength="6" value="<?php echo e(old('code')); ?>" required autocomplete="off">
            <div class="form-text">Le code expire dans 15 minutes.</div>
        </div>
        <button type="submit" class="btn btn-primary w-100 mb-3">
            <i class="bi bi-check-circle me-2"></i>Vérifier mon email
        </button>
    </form>
    ...
    <form method="POST" action="<?php echo e(route('verification.resend')); ?>">
        ...
        <button type="submit" class="btn btn-outline-primary w-100">
            <i class="bi bi-arrow-clockwise me-2"></i>Renvoyer le code
        </button>
    </form>
...
<?php /**PATH D:\xamppp\htdocs\PF\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>