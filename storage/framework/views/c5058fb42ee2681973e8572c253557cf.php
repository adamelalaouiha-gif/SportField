                    ...
                    <div class="info-card">
                        ...
                        <?php $__currentLoopData = $horaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jour => $heure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex justify-content-between py-2 border-bottom">
                                ...
                                <?php if(is_array($heure)): ?>
                                    <?php if(!empty($heure['ouverture']) && !empty($heure['fermeture'])): ?>
                                        <span class="text-muted"><?php echo e($heure['ouverture']); ?> – <?php echo e($heure['fermeture']); ?></span>
                                    <?php else: ?>
