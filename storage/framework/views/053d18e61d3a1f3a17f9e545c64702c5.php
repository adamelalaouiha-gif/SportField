<?php $__env->startSection('title', 'À propos - SportsField'); ?>
...
<main>
    ...
    <section class="container mb-5">
        <div class="bg-primary text-white rounded-4 p-5 text-center">
            ...
            <a href="<?php echo e(route('clubs.index')); ?>" class="btn btn-light btn-lg text-primary fw-bold px-4">Trouver un terrain</a>
        </div>
    </section>
</main>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xamppp\htdocs\PF\resources\views/Visiteur/Apropos.blade.php ENDPATH**/ ?>