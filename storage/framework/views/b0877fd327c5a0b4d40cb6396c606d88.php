...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?php echo e(route('password.forgot')); ?>" class="text-decoration-none small text-primary">
                ...
                <p class="text-center text-muted small mb-0">
                    Pas encore de compte ? <a href="<?php echo e(route('register')); ?>" class="text-decoration-none fw-semibold text-primary">Créer un compte</a>
                </p>
            </form>
            <hr class="my-4">
...
<?php /**PATH D:\xamppp\htdocs\PF\resources\views/auth/login.blade.php ENDPATH**/ ?>